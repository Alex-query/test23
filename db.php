...
class DatabaseHandler
{
    ...
    private static function GetHandler()
    {
        ...
        if (!isset(self::$_mHandler))
        {
            ...
            try
            {
                ...
                self::$_mHandler =  new PDO('mysql:host=localhost;dbname='.self::$_db, 'root', 'Zxcvbnm1');
                ...
                //self::$_mHandler->query("SET CHARACTER SET utf8");
    ...
    public static function ExecuteLastId($sqlQuery, $params = null)
    {
                                  ...
                                  $fetchStyle = PDO::FETCH_ASSOC)
    {
        ...
        try
        {
            ...
            //echo $statement_handler->fetchColumn();
            //echo (pg_affected_rows ($statement_handler));
